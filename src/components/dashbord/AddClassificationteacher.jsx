...
const AddClassificationteacher = ({ setItem }) => {
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Grid container spacing={3}>
          <Grid item sm={12}>
            <Box>
              <Typography varient="h5">مدرس</Typography>
          ...
          <Grid item sm={12}>
            <Box>
              <Typography varient="h5">درس</Typography>
              <FormControl sx={{ width: "100%", marginTop: "10px" }}>
                <Select
                  open={openteacher}
                  onOpen={() => setOpenteacher(true)}
                ...
                >
                  <MenuItem value="" disabled>
                    درس مد‌نظر را انتخاب کنید{" "}
                  </MenuItem>
                  <MenuItem value={0}>ریاضی</MenuItem>
                  <MenuItem value={1}>فیزیک</MenuItem>
                  <MenuItem value={2}>شیمی</MenuItem>
                </Select>
              </FormControl>
            </Box>
          </Grid>
...
export default AddClassificationteacher;
